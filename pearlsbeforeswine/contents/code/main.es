...
const websitePart = "pearlsbeforeswine"; //e.g. the "garfield" in "http://www.gocomics.com/garfield/"
const firstIdentifier = "2002/01/07";
...
function pageRetrieved(id, data)
{
    ...
    if (id == comic.User) {
        ...
        // e.g., look for : data-url="http://www.gocomics.com/pearlsbeforeswine/2017/01/11
