...
const author = "Mike Luckovich"
const websitePart = "mikeluckovich"; //e.g. the "garfield" in "http://www.gocomics.com/garfield/"
const comicName = "Mike Luckovich"; //needed to find the most recent strip, the name that is displayed next to the "by comic author" on the website
const firstIdentifier = "2002-08-06";
