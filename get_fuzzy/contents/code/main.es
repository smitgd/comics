...
const author = "Darby Conley";
const websitePart = "getfuzzy"; //e.g. the "garfield" in "http://www.gocomics.com/garfield/"
const comicName = "Get Fuzzy"; //needed to find the most recent strip, the name that is displayed next to the "by comic author" on the website
const firstIdentifier = "2000-01-01";
const shopUrl = "";
