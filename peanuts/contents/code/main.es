...
const author = "Charles Schulz";
const websitePart = "peanuts"; //e.g. the "garfield" in "http://www.gocomics.com/garfield/"
const comicName = "Peanuts"; //needed to find the most recent strip, the name that is displayed next to the "by comic author" on the website
const firstIdentifier = "1950-10-02";
const shopUrl = "http://gocomics.com/peanuts";
